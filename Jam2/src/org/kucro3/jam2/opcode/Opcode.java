...
public class Opcode {
	...
	private static void init()
	{
		...
		OPCODES[0x0E] = new Opcode("dconst_0", 0x0E, VOID, 2);
		OPCODES[0x0F] = new Opcode("dconst_1", 0x0F, VOID, 2);
		...
		OPCODES[0x99] = new Opcode("ifeq", 0x99, JMP, -1);
		OPCODES[0x9A] = new Opcode("ifne", 0x9A, JMP, -1);
		OPCODES[0x9B] = new Opcode("iflt", 0x9B, JMP, -1);
		OPCODES[0x9C] = new Opcode("ifge", 0x9C, JMP, -1);
		OPCODES[0x9D] = new Opcode("ifgt", 0x9D, JMP, -1);
		OPCODES[0x9E] = new Opcode("ifle", 0x9E, JMP, -1);
